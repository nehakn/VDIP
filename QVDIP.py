...
from .QVDIP_dialog import QVDIPDialog
import os.path
...
class QVDIP:
    ...
    def __init__(self, iface):
        ...
        # added on 16/05/2022
        self.dlg=QVDIPDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&QVDIP')

        # added on 15/05/2022
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'QVDIP')
        self.toolbar.setObjectName(u'QVDIP')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QVDIP', message)
    ...
    def add_action(
        ...
        # adding some actions here. added on 16/05/2022.
        self.ini_display()
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/QVDIP/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QVDIP'),
            callback=self.run,
        ...
        # functionality added on 16/05/2022
    ...
    def run(self):
        ...
        # show the dialog
        self.dlg.show()
        # added on 12/05/2022 fixing the box size
    ...
    # displaying contents on the display box to the right. text browser is used
    # these are fixed contents for display on opening the plugin
    # added on 15/05/2022 to display contents
    def ini_display(self):
        # For terminal outputs
        # tb_display is name of the text display browser
        logger = self.dlg.tb_display
        logger.append(
            'Q-VDIP: QGIS-Vegetation and Drought Indices Parameter computation\n'
